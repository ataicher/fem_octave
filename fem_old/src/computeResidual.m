...
for c=1:numCells
    ...
    for f=1:numFields
        ...
        for q=1:numQuadPoints
            ...
            % point
            vFormVVal = varForm.v(uVal{q},gradUVal{q},realQuadPoints(1,q),realQuadPoints(2,q));
            vFormGradVVal = varForm.gradV(uVal{q},gradUVal{q},realQuadPoints(1,q),realQuadPoints(2,q));
            ...
            for comp=1:numComp
                ...
                for d=1:dim
                    elemVec = elemVec + detJ*quadWeights(q)*rBasisDer(:,d,comp,q)*vFormGradVVal(comp,d);
                end
            end
        end
