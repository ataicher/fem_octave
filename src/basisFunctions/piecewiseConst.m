...
%
function [numComp, numBasisFuncs, refNodes, basisInfo] = piecewiseConst
% 
numComp = 1;
numBasisFuncs = 1;
...
basisInfo(1).fun = @(x,y) 1;
basisInfo(1).gradFun = @(x,y) [ 0 ; 0];
basisInfo(1).geoType = 'face';
basisInfo(1).geoNum = 1;
basisInfo(1).DOFType = 'averageVal';
